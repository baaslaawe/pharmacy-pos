...
<div class="page-header">
    ...
    <button onclick="openDevDialog(0);" id="addbtn" class="btn btn-primary btn-sm pull-right"><i
    ...
    <div class="col-xs-12">
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <table id="devtable" class="table table-striped table-bordered table-hover dt-responsive"
                       style="width:100%;">
                    <thead>
                    <tr>
        ...
        <div class="page-header">
            ...
            <button onclick="openLocDialog(0);" id="addbtn" class="btn btn-primary btn-sm pull-right"><i
                        class="icon-pencil align-top bigger-125"></i>Add
            </button>
        </div><!-- /.page-header -->
        <div class="row" style="margin-top: 10px;">
            <div class="col-xs-12">
                ...
                <table id="loctable" class="table table-striped table-bordered table-hover dt-responsive"
                       style="width:100%;">
                    <thead>
                    <tr>
                        <th data-priority="0">ID</th>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td><select id="devtype" onchange="showDeviceOptions($(this).val());">
                                ...
                                <option class="reg_device" value="order_register">Order Register (alpha version)
                                </option>
                                <option class="kitchen_device" value="kitchen_terminal">Kitchen/Bar Terminal (alpha
                                    version)
                                </option>
                            </select></td>
                    </tr>
        ...
        $(function () {
                ...
                "aoColumns": [
                    ...
                    {"mData": "locationname"},
                    {
                        "mData": function (data, type, val) {
                            switch (data.type) {
                                case 'kitchen_terminal':
                                    return 'Kitchen/Bar Terminal';
                    ...
                    {
                        "mData": function (data, type, val) {
                            return '<i class="' + (data.disabled == 1 ? 'red icon-arrow-down' : 'green icon-arrow-up') + '"></i>';
                        }
                    },
                    {
                        "mData": function (data, type, val) {
                            return data.id == 0 ? '' : '<div class="action-buttons"><a class="green" onclick="openDevDialog($(this).closest(\'tr\').find(\'td\').eq(0).text());"><i class="icon-pencil bigger-130"></i></a>' +
                                (data.disabled == 1 ? '<a class="green" onclick="setItemDisabled(0, $(this).closest(\'tr\').find(\'td\').eq(0).text(), false)"><i class="icon-arrow-up bigger-130"></i></a><a class="red" onclick="removeDevItem($(this).closest(\'tr\').find(\'td\').eq(0).text())"><i class="icon-trash bigger-130"></i></a>' : '<a class="red" onclick="setItemDisabled(0, $(this).closest(\'tr\').find(\'td\').eq(0).text(), true)"><i class="icon-arrow-down bigger-130"></i></a>') + '</div>';
                        }, "bSortable": false
                    }
                ],
                "columns": [
            ...
            loctable = $('#loctable').dataTable({
                ...
                "aoColumns": [
                    ...
                    {
                        "mData": function (data, type, val) {
                            return data.id == 0 ? '' : '<div class="action-buttons"><a class="green" onclick="openLocDialog($(this).closest(\'tr\').find(\'td\').eq(0).text());"><i class="icon-pencil bigger-130"></i></a>' +
                                (data.disabled == 1 ? '<a class="green" onclick="setItemDisabled(1, $(this).closest(\'tr\').find(\'td\').eq(0).text(), false)"><i class="icon-arrow-up bigger-130"></i></a><a class="red" onclick="removeLocItem($(this).closest(\'tr\').find(\'td\').eq(0).text())"><i class="icon-trash bigger-130"></i></a>' : '<a class="red" onclick="setItemDisabled(1, $(this).closest(\'tr\').find(\'td\').eq(0).text(), true)"><i class="icon-arrow-down bigger-130"></i></a>') + '</div>';
                        }, "bSortable": false
                    }
                ],
                "columns": [
