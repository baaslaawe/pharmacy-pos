        ...
        <div class="widget-box transparent">
            ...
            <div class="widget-body" style="padding-top: 10px;">
                <form class="form-horizontal">
                    ...
                    <small>The host and user specified must be allowed to send mail as the email address specified
                        above.
                    </small>
                </form>
            </div>
            ...
            <div class="widget-body" style="padding-top: 10px;">
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <a class="congaccn" style="display: none;" href="javascript:initGoogleAuth();">Connect
                                Google Account</a>
                            <a class="disgaccn" style="display: none;" href="javascript:removeGoogleAuth();">Disconnect
                                Google Account</a>
                        </div>
                    </div>
                    <div class="space-4"></div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input class="congaccn" style="display: none;" placeholder="Paste Google Auth Code"
                                   type="text" id="gcontactcode"/>
                        </div>
                    </div>
                </form>
            </div>
