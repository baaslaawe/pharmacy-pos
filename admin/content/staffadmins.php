...
<div class="page-header">
    ...
    <button onclick="$('#adduserdialog').dialog('open');" id="addbtn" class="btn btn-primary btn-sm pull-right"><i
    ...
    <div class="col-xs-12">
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <table id="usertable" class="table table-striped table-bordered table-hover dt-responsive"
                       style="width:100%;">
                    <thead>
                    <tr>
    ...
    <div style="display: inline-block; min-width: 325px; vertical-align: top; padding-bottom: 20px; margin: 0;padding-right: 10px;">
        ...
        <table>
            ...
            <tr>
                ...
                <td><input id="userpass" class="form-control" type="password" value=""
                           placeholder="Leave blank to ignore"/></td>
            </tr>
            <tr>
        ...
        <table class="table" style="min-width: 325px;">
            ...
            <tr>
                ...
                <td>
                    ...
                    <label>Edit: <input id="permsaleedit" type="checkbox" class="permcb"/> </label><br/>(notes update is
                    allowed by all)
                </td>
            </tr>
            <tr>
    ...
    $(function () {
        ...
        datatable = $('#usertable').dataTable({
            ...
            "aoColumns": [
                ...
                {
                    mData: function (data, type, val) {
                        return data.id == 0 ? '' : '<div class="action-buttons"><a class="green" onclick="openEditUserDialog($(this).closest(\'tr\').find(\'td\').eq(0).text());"><i class="icon-pencil bigger-130"></i></a>' +
                            (data.id != 1 ? (data.disabled == 1 ? '<a class="green" onclick="setUserDisabled($(this).closest(\'tr\').find(\'td\').eq(0).text(), false)"><i class="icon-arrow-up bigger-130"></i></a><a class="red" onclick="removeItem($(this).closest(\'tr\').find(\'td\').eq(0).text())"><i class="icon-trash bigger-130"></i></a>' : '<a class="red" onclick="setUserDisabled($(this).closest(\'tr\').find(\'td\').eq(0).text(), true)"><i class="icon-arrow-down bigger-130"></i></a>') : '') + '</div>';
                    }, "bSortable": false
                }
            ],
            "columns": [
