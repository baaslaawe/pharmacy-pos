...
<div class="page-header">
    ...
    <button class="btn btn-success btn-sm pull-right" style="margin-right: 10px;" onclick="openImportDialog();"><i
                class="icon-cloud-upload align-top bigger-125"></i>Update Non-Inventory
    </button>
</div><!-- /.page-header -->
    ...
    <div class="col-xs-12">
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <table id="noninvtable" class="table table-striped table-bordered table-hover dt-responsive"
                       style="width:100%;">
                    <thead>
                    <tr>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        datatable = $('#noninvtable').dataTable({
            "bProcessing": true,
            "aaData": stockarray,
            "aaSorting": [[2, "asc"]],
            ...
            "aoColumns": [
                ...
                {
                    mData: function (data, type, val) {
                        return '<div class="action-buttons"><a class="green" onclick="openEditStockDialog(' + data.id + ');"><i class="icon-pencil bigger-130"></i></a><a class="red" onclick="deleteStockItem(' + data.id + ');"><i class="icon-trash bigger-130"></i></a></div>';
                    }, "bSortable": false
                }
            ],
            "columns": [
