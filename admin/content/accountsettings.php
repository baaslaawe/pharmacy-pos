...
<div class="row">
        ...
        <div class="widget-box transparent">
            ...
            <div style="padding-top: 10px;">
                ...
                <div class="table-responsive">
                    ...
                    <br/>
                    <button id="addtaxrulebtn" class="btn btn-primary btn-sm pull-right" onclick="openTaxRuleDialog(0)">
                        <i class="icon-pencil align-top bigger-125"></i>Add
                    </button>
                </div>
            </div>
        </div>
        ...
        <div class="widget-box transparent">
            ...
            <div style="padding-top: 10px;">
                <div class="table-responsive">
                    ...
                    <br/>
                    <button id="addtaxitembtn" class="btn btn-primary btn-sm pull-right" onclick="openTaxItemDialog(0)">
                        <i class="icon-pencil align-top bigger-125"></i>Add
                    </button>
                </div>
            </div>
    ...
    <div class="col-sm-6" style="display: none;">
            ...
            <div class="widget-body" style="padding-top: 10px;">
                <form id="accnsettings" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <a class="conxaccn" style="display: none;" href="javascript:initXeroAuth();">Connect Xero
                                Account</a>
                            <a class="disxaccn" style="display: none;" href="javascript:removeXeroAuth();">Disconnect
                                Xero Account</a>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-7 disxaccn" style="display: none;">
                            <table class="table table-responsive">
                                ...
                                <tr>
                                    ...
                                    <td><label>Refunds<select id="xeromap-refunds" class="width-100"></select></label>
                                    </td>
                                </tr>
                                <tr>
                                    <td><label>Cash Payments<select id="xeromap-pay-cash"
                                                                    class="xeropayselect width-100"></select></label>
                                    </td>
                                    <td><label>Card Payments<select id="xeromap-pay-card"
                                                                    class="xeropayselect width-100"></select></label>
                                    </td>
                                </tr>
                                <tr>
                                    <td><label>Deposit Payments<select id="xeromap-pay-deposit"
                                                                       class="xeropayselect width-100"></select></label>
                                    </td>
                                    <td><label>Mpesa Payments<select id="xeromap-pay-cheque"
                                                                     class="xeropayselect width-100"></select></label>
                                    </td>
                                </tr>
                                </tbody>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5 disxaccn">
                            <button type="button" class="btn btn-primary btn-sm" onclick="showSalesExportDialog();">
                                Export Sales to Xero
                            </button>
                        </div>
                    </div>
                </form>
        ...
        <div class="col-sm-12 align-center form-actions">
            <button class="btn btn-success" type="button" onclick="saveSettings();"><i
...
<div id="edittaxruledialog" class="hide" style="min-width: 375px;">
    <table>
        ...
        <tr>
            ...
            <td><input id="taxruleinc" type="checkbox"/><br/>
                <small>Tax is included in item unit price</small>
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <br/>
                <small>Single: Applies first matched location tax, or base tax if there is no match<br/>
                    Multiple: Allows multiple taxes to be applied to an item
                </small>
            </td>
        </tr>
    </table>
                ...
                "aoColumns": [
                    {"mData": "id"}, {"mData": "name"},
                    {
                        "mData": function (data, type, val) {
                            return data.inclusive ? '<i class="icon-cogs green"></i>&nbsp;Inclusive' : '<i class="icon-cogs red"></i>&nbsp;Exclusive'
                        }
                    },
                    {
                        "mData": function (data, type, val) {
                            return data.hasOwnProperty('mode') ? WPOS.util.capFirstLetter(data.mode) : '';
                        }
                    },
                    {
                        "mData": function (data, type, val) {
                            if (data.id == 1) return ""; else return '<div class="action-buttons" style="width: 40px;"><a class="green" onclick="openTaxRuleDialog($(this).closest(\'tr\').find(\'td\').eq(0).text());"><i class="icon-pencil bigger-130"></i></a>' +
                                '<a class="red" onclick="deleteTaxRule($(this).closest(\'tr\').find(\'td\').eq(0).text())"><i class="icon-trash bigger-130"></i></a></div>';
                        }, "bSortable": false
                    }
                ]
            });
        ...
        taxitemtable = $('#tax-item-table').dataTable(
            {
                ...
                "aaData": itemarray,
                "aoColumns": [
                    {"mData": "id"}, {"mData": "name"}, {"mData": "type"}, {
                        "mData": function (data, type, val) {
                            return data.value + "%";
                        }
                    },
                    {
                        "mdata": null,
                        "sDefaultContent": '<div class="action-buttons" style="width: 40px;"><a class="green" onclick="openTaxItemDialog($(this).closest(\'tr\').find(\'td\').eq(0).text());"><i class="icon-pencil bigger-130"></i></a>' +
                            '<a class="red" onclick="deleteTaxItem($(this).closest(\'tr\').find(\'td\').eq(0).text())"><i class="icon-trash bigger-130"></i></a></div>',
                        "bSortable": false
                    }
                ]
            });
