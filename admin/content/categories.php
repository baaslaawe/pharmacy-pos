...
<div class="page-header">
    ...
    <button onclick="$('#addcatdialog').dialog('open');" id="addbtn" class="btn btn-primary btn-sm pull-right"><i
    ...
    <div class="col-xs-12">
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <table id="categoriestable" class="table table-striped table-bordered table-hover dt-responsive"
                       style="width: 100%;">
                    <thead>
                    <tr>
    ...
    $(function () {
        ...
        datatable = $('#categoriestable').dataTable({
            ...
            "aoColumns": [
                ...
                {
                    mData: null,
                    sDefaultContent: '<div class="action-buttons"><a class="green" onclick="openeditcatdialog($(this).closest(\'tr\').find(\'td\').eq(1).text());"><i class="icon-pencil bigger-130"></i></a><a class="red" onclick="removeCategory($(this).closest(\'tr\').find(\'td\').eq(1).text())"><i class="icon-trash bigger-130"></i></a></div>',
                    "bSortable": false,
                    sClass: "noexport"
                }
            ],
