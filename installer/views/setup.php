...
<div>
    ...
    <form role="form" class="form-horizontal" method="post" onsubmit="return validatePassword();">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input name="cpassword" id="cpassword" type="password" class="col-xs-10 col-sm-5"
        ...
        <div class="form-group hide" id="months">
            ...
            <div class="col-sm-9">
                <input name="months" id="tmonths" type="text" class="col-xs-10 col-sm-5"
        ...
        <div style="height: 40px;">
            <button type="button" class="pull-left btn btn-primary"
                    onclick="document.location.href='/installer?screen=2';">Back
            </button>
