...
function WPOSReports() {
    ...
    this.generateTakingsReport = function () {
        var html = reportheader("Cash Count Report") + '<table style="width:100%;" class="table table-stripped"><thead><tr><th>Method</th><th># Payments</th><th>Cash</th><th># Refunds</th><th>Refunds</th><th>Balance</th></tr></thead><tbody>';
        var methdenoms = getOverviewStats().methodtotals;
    ...
    this.generateSellerReport = function () {
        var html = reportheader("Seller Cash") + '<table style="width:100%;" class="table table-stripped"><thead><tr><th>User</th><th>Sales</th><th>Voids</th><th>Refunds</th><th>Balance</th></tr></thead><tbody>';
