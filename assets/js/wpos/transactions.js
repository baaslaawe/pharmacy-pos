...
function WPOSTransactions() {
    ...
    datatable = $('#transactiontable').dataTable(
        {
            ...
            "aoColumns": [
                ...
                {
                    "sType": "numeric", "mData": function (data, type, val) {
                ...
                {
                    "sType": "html", mData: function (data, type, val) {
                        return "<button class='btn btn-sm btn-primary' onclick='WPOS.trans.showTransactionInfo(" + "\"" + data.ref + "\"" + ")'>View</button>";
                    }, "bSortable": false
                }
            ],
            "columns": [
    ...
    function updateSaleNotes() {
        ...
        if (answer) {
            ...
            WPOS.sendJsonDataAsync("sales/updatenotes", JSON.stringify({
                "ref": ref,
                "notes": notes
            }), function (result) {
    ...
    function updateSalePayments() {
        ...
        var ref = sale.ref;
        WPOS.util.showLoader();
        WPOS.sendJsonDataAsync("sales/updatepayments", JSON.stringify({
            "ref": sale.ref,
