...
function WPOSPrint(kitchenMode) {
    ...
    function printCurrentReport() {
        ...
        switch (getPrintSetting('reports', 'method')) {
            case "br":
                browserPrintHtml($("#reportcontain").html(), 'QuePharm Report', 600, 800);
                break;
            case "qz":
                alert("QZ-Print integration is no longer available, switch to the new webprint applet");
                break;
    ...
    this.printArbReceipt = function (printer, text) {
        ...
        switch (method) {
            case "br":
                browserPrintHtml("<pre style='text-align: center; background-color: white;'>" + text + "</pre>", 'QuePharm Receipt', 310, 600);
                return true;
            case "qz":
                alert("QZ-Print integration is no longer available, switch to the new webprint applet");
                return false;
  ...
  this.printInvoice = function (record) {
    ...
    function printReceipt(ref, record) {
        ...
        switch (method) {
            case "br":
                browserPrintHtml(getHtmlReceipt(record, false), 'QuePharm Receipt', 610, 500);
                return true;
            case "qz":
                alert("QZ-Print integration is no longer available, switch to the new webprint applet");
                return false;
  ...
  function printInvoice(record) {
    ...
    switch (method) {
      case "br":
          browserPrintHtml(getHtmlInvoice(record, false, true), 'QuePharm Invoice', 600, 800);
        return true;
      case "qz":
        alert("QZ-Print integration is no longer available, switch to the new webprint applet");
        return false;
