...
(function ($) {
    $.fn.scannerDetection = function (options) {
        ...
        this.each(function () {
            var self = this, $self = $(self), firstCharTime = 0, lastCharTime = 0, stringWriting = '',
                callIsScanner = false, testTimer = false;
            ...
            self.scannerDetectionTest = function (s) {
                ...
                if (stringWriting.length >= options.minLength && lastCharTime - firstCharTime < stringWriting.length * options.avgTimeByChar) {
                    if (options.onComplete && !options.ignoredField.is(':focus')) options.onComplete.call(self, stringWriting);
